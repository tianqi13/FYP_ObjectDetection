...
from mmdet.datasets import BaseDetDataset, TankDataset
...
class YOLOv5TankDataset(BatchShapePolicyDataset, TankDataset):
    """Dataset for YOLOv5 COU Dataset.

    We only add `BatchShapePolicy` function compared with TankDataset. See
