...
from mmdet.datasets import BaseDetDataset, COUDataset
...
class YOLOv5COUDataset(BatchShapePolicyDataset, COUDataset):
    """Dataset for YOLOv5 COU Dataset.

    We only add `BatchShapePolicy` function compared with COUDataset. See
